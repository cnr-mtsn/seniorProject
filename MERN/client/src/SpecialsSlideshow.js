    ...
    return (
        <Carousel>
            ...
            <Carousel.Caption className="specialDetails">
                ...
                <p>Corned beef and pastrami sandwich with Swiss and spicy brown mustard on marbled rye!</p>
            </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
            <Image
            ...
            <Carousel.Caption className="specialDetails">
                ...
                <p>Bread slices are layered with fresh mozzarella, fresh basil and fresh tomatoes then cooked in a hot skillet until golden brown and melty delicious!</p>
            </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
            <Image
            ...
            <Carousel.Caption className="specialDetails">
                ...
                <p>Black Angus roast beef with melted Swiss on a toasted baguette and served with yummy au jus dipping sauce!</p>
            </Carousel.Caption>
        </Carousel.Item>
